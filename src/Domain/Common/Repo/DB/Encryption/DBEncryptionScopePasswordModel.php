...
{
	public const string MODEL_ALIAS = 'EncryptionScopePassword';

	public const string TABLE_NAME = 'EncryptionScopePasswords';

	public const string ENTITY_CLASS = 'DDD\Domain\Common\Entities\Encryption\EncryptionScopePassword';
