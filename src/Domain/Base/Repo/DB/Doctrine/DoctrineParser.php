...
class DoctrineParser extends Parser
{
    /**
     ...
     * @psalm-var array<string, class-string<Functions\FunctionNode>>
     */
    protected static $numericFunctions = [
     ...
     * @psalm-var array<string, class-string<Functions\FunctionNode>>
     */
    protected static $datetimeFunctions = [
     ...
     */
    protected $customOutputWalker;

    /** @psalm-var array<string, AST\SelectExpression> */
    protected $identVariableExpressions = [];
     ...
     */
    protected function fixIdentificationVariableOrder(AST\Node $AST): void
    {
     ...
     */
    protected function peekBeyondClosingParenthesis(bool $resetPeek = true)
    {
     ...
     */
    protected function isAggregateFunction(int $tokenType): bool
    {
        return in_array(
            $tokenType,
     ...
     */
    protected function isNextAllAnySome(): bool
    {
        assert($this->lexer->lookahead !== null);
     ...
     */
    protected function processDeferredIdentificationVariables(): void
    {
     ...
     */
    protected function processDeferredNewObjectExpressions(AST\SelectStatement $AST): void
    {
     ...
     * It must exist in query components list.
     */
    protected function processDeferredPartialObjectExpressions(): void
    {
     ...
     * It must exist in query components list.
     */
    protected function processDeferredResultVariables(): void
    {
     ...
     */
    protected function processDeferredPathExpressions(): void
    {
    ...
    protected function processRootEntityAliasSelected(): void
    {
     ...
     */
    protected function validateAbstractSchemaName(string $schemaName): void
    {
        assert($this->lexer->token !== null);
     ...
     */
    protected function CustomFunctionDeclaration(): ?Functions\FunctionNode
    {
        assert($this->lexer->lookahead !== null);
        $token    = $this->lexer->lookahead;
        $funcName = strtolower($token->value);
