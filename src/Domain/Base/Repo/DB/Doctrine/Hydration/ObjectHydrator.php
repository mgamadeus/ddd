...
namespace DDD\Domain\Base\Repo\DB\Doctrine\Hydration;
...
class ObjectHydrator extends AbstractHydrator
{
    ...
    protected $uninitializedCollections = [];

    /** @var mixed[] */
    protected $existingCollections = [];
     ...
     * @return mixed[]
     */
    public function init($stmt, $resultSetMapping, array $hints = [])
    {
        $this->_stmt  = $stmt;
    ...
    public function cleanupAfterRowIteration(): void
    {
        $this->identifierMap            =
        $this->initializedCollections   =
        $this->uninitializedCollections =
     ...
     */
    public function initRelatedCollection(
        $entity,
        ClassMetadata $class,
        string $fieldName,
     ...
     */
    public function getEntity(array $data, string $dqlAlias)
    {
     ...
     * @return mixed
     */
    public function getEntityFromIdentityMap(string $className, array $data)
    {
     ...
     * @return void
     */
    public function hydrateRowData(array $row, array &$result)
    {
        // Initialize
