...
class ChangeHistory extends ValueObject
{
    ...
    public const string DATETIME_ATOM = 'datetime_atom';

    public const string DATETIME_SIMPLE = 'datetime_simple';

    public const string DEFAULT_CREATED_COLUMN_NAME = 'created';

    public const string DEFAULT_MODIFIED_COLUMN_NAME = 'updated';

    public const string DEFAULT_COLUMN_STYLE = self::DATETIME_SIMPLE;
