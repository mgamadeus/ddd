...
class ResponseBodySchema
{
    ...
    public function __construct(ReflectionClass &$responseDtoReflectionClass)
    {
        if (is_a($responseDtoReflectionClass->getName(), RestResponseDto::class, true) ||
            is_a($responseDtoReflectionClass->getName(), Exception::class, true)
        ) {
        ...
        } elseif (is_a($responseDtoReflectionClass->getName(), ImageResponseDto::class, true) || is_a($responseDtoReflectionClass->getName(), PDFResponseDto::class, true)) {
