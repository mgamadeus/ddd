...
namespace DDD\Infrastructure\Cache\Predis\Connection\Replication;
...
/**
 * @author Danieløe Alessandri <suppakilla@gmail.com>
...
class SentinelReplication implements ReplicationInterface
{
     ...
     * number overrides the default sentinel timeout.
     *
     * @param float $timeout Timeout number.
     */
    ...
    public function updateSentinels()
    {
        ...
        try {
            $payload = $sentinel->executeCommand(RawCommand::create('SENTINEL', 'sentinels', $this->service));
    ...
    {
        $payload = $sentinel->executeCommand(RawCommand::create('SENTINEL', 'get-master-addr-by-name', $service));
