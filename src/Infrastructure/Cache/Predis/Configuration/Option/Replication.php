...
namespace DDD\Infrastructure\Cache\Predis\Configuration\Option;

use DDD\Infrastructure\Cache\Predis\Connection\Replication\SentinelReplication;
...
class Replication extends Aggregate
{
    ...
    public function filter(OptionsInterface $options, $value)
    {
        ...
        if (is_callable($value)) {
            ...
            throw new InvalidArgumentException(
                sprintf(
                    '%s expects either a string or a callable number, %s given',
                    static::class,
    ...
    {
        return $this->getConnectionInitializer($options, $this->getDefaultConnectionInitializer());
    }
}
