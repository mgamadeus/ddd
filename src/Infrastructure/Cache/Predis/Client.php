...
namespace DDD\Infrastructure\Cache\Predis;

use ArrayIterator;
use DDD\Infrastructure\Cache\Predis\Configuration\Options;
...
class Client implements ClientInterface, IteratorAggregate
{
     ...
     * connection by the specified number. Supported selectors are:
     *
     *   - `id`
     *   - `key`
     *   - `slot`
     ...
     *
     *   $selector string => getConnectionBy$selector($number) method
     *
