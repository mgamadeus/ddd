...
abstract class Cache
{
    ...
    public const int CACHE_TTL_ONE_HOUR = 3600;

    public const int CACHE_TTL_TEN_MINUTES = 600;

    public const int CACHE_TTL_ONE_WEEK = 604800;

    public const int CACHE_TTL_ONE_MONTH = 2292000;

    public const string CACHE_GROUP_APC = 'apc';

    public const string CACHE_GROUP_PHPFILES = 'phpfiles';

    public const string CACHE_GROUP_REDIS = 'redis';

    public const string CACHE_GROUP_REDIS_SENTINEL = 'redisSentinel';

    // Default Groups
    protected const string CACHE_TYPE_APC = 'apc';

    protected const string CACHE_TYPE_REDIS = 'redis';
